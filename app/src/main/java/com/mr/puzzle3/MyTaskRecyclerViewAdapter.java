...
import com.mr.puzzle3.TaskFragment.OnListFragmentInteractionListener;
import com.mr.puzzle3.TaskListContent.Task;
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        if(picPath != null && !picPath.isEmpty()){
            if(picPath.contains("avatar")){
                ...
                switch(picPath){
                    case "avatar 1":
                        taskDrawable = context.getResources().getDrawable(R.drawable.flaming);
                        break;
                    case "avatar 2":
                        taskDrawable = context.getResources().getDrawable(R.drawable.flaming);
                        break;
            ...
            holder.mItemImageView.setImageDrawable(context.getResources().getDrawable(R.drawable.flaming));
        }
